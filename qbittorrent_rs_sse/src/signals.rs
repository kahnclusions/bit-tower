...
pub struct Torrent {
    ...
    pub downloaded: RwSignal<f64>,
    pub uploaded: RwSignal<f64>,
    pub dlspeed: RwSignal<f64>,
...
impl From<TorrentInfo> for Torrent {
    fn from(value: TorrentInfo) -> Self {
        Torrent {
            ...
            downloaded: RwSignal::new(value.downloaded),
            uploaded: RwSignal::new(value.uploaded),
            dlspeed: RwSignal::new(value.dlspeed),
